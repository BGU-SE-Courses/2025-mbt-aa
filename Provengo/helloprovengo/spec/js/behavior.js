...
bthread("studentSubscribesToAForumDiscussion", function(){
  ...
  sync({request: Event("End-enterToForumDiscussionAndSubscribe"), waitFor: Event("Start-enterToForumDiscussionAndDeleteDiscussion")},
    enterToForumDiscussionAndDeleteDiscussion(session1))
});
...
// this bthread assures that before the teacher deleted the discussion, the student cant subscribe to it
bthread("teacherDeletesTheDiscussionWhileStudentIsWaiting", function(){
  sync({
    waitFor:Event("End-enterToForumDiscussionAndDeleteDiscussion"),
    block: Event("Start-enterToForumDiscussionAndSubscribe")
  });
});
